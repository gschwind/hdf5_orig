...
ACLOCAL = ${SHELL} /home/SOPHIA/benoit.gschwind/projects/hdf5_orig/bin/missing --run aclocal-1.12
...
AM_CFLAGS =  -std=c99 -pedantic -Wall -Wextra -Wundef -Wshadow -Wpointer-arith -Wbad-function-cast -Wcast-qual -Wcast-align -Wwrite-strings -Wconversion -Waggregate-return -Wstrict-prototypes -Wmissing-prototypes -Wmissing-declarations -Wredundant-decls -Wnested-externs -Winline -Wfloat-equal -Wmissing-format-attribute -Wmissing-noreturn -Wpacked -Wdisabled-optimization -Wformat=2 -Wendif-labels -Wdeclaration-after-statement -Wold-style-definition -Winvalid-pch -Wvariadic-macros -Winit-self -Wmissing-include-dirs -Wswitch-default -Wswitch-enum -Wunused-macros -Wunsafe-loop-optimizations -Wc++-compat -Wstrict-overflow -Wlogical-op -Wlarger-than=2048 -Wvla -Wsync-nand -Wframe-larger-than=16384 -Wpacked-bitfield-compat -Wstrict-overflow=5 -Wjump-misses-init -Wunsuffixed-float-constants -Wdouble-promotion -Wsuggest-attribute=const -Wtrampolines -Wstack-usage=8192 -Wvector-operation-performance -Wsuggest-attribute=pure -Wsuggest-attribute=noreturn -O3 -fomit-frame-pointer -finline-functions
...
AR = ar
AS = as
AUTOCONF = ${SHELL} /home/SOPHIA/benoit.gschwind/projects/hdf5_orig/bin/missing --run autoconf
AUTOHEADER = ${SHELL} /home/SOPHIA/benoit.gschwind/projects/hdf5_orig/bin/missing --run autoheader
AUTOMAKE = ${SHELL} /home/SOPHIA/benoit.gschwind/projects/hdf5_orig/bin/missing --run automake-1.12
AWK = gawk
...
CLEARFILEBUF = yes
CODESTACK = no
CONFIG_DATE = Thu Jan 16 13:49:42 CET 2014
CONFIG_MODE = production
CONFIG_USER = benoit.gschwind@elnino
CPP = gcc -E
CPPFLAGS = 
CXX = no
CXXCPP = g++ -E
...
LT_STATIC_EXEC = 
MAINT = #
MAKEINFO = ${SHELL} /home/SOPHIA/benoit.gschwind/projects/hdf5_orig/bin/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MPE = no
MPI_GET_SIZE = 
...
PERL = perl
RANLIB = ranlib
ROOT = /home/SOPHIA/benoit.gschwind/projects/hdf5_orig
RUNPARALLEL = 
RUNSERIAL = 
R_INTEGER = 
R_LARGE = 
...
TR = /usr/bin/tr
TRACE_API = no
UNAME_INFO = Linux elnino 3.10.25-gentoo #1 SMP PREEMPT Mon Jan 6 16:23:52 CET 2014 x86_64 Intel(R) Core(TM) i5-2500 CPU @ 3.30GHz GenuineIntel GNU/Linux
...
VERSION = 1.8.12
WORDS_BIGENDIAN = no
abs_builddir = /home/SOPHIA/benoit.gschwind/projects/hdf5_orig
abs_srcdir = /home/SOPHIA/benoit.gschwind/projects/hdf5_orig
abs_top_builddir = /home/SOPHIA/benoit.gschwind/projects/hdf5_orig
abs_top_srcdir = /home/SOPHIA/benoit.gschwind/projects/hdf5_orig
ac_ct_AR = 
ac_ct_CC = gcc
ac_ct_CXX = 
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/SOPHIA/benoit.gschwind/projects/hdf5_orig/bin/install-sh
...
pdfdir = ${docdir}
prefix = /home/SOPHIA/benoit.gschwind/projects/hdf5_orig/hdf5
...
install-examples uninstall-examples:
	@set -x; for d in examples $(HDF5_INTERFACES) $(HL); do               \
	    (cd $$d && $(MAKE) $(AM_MAKEFLAGS) $@) || exit 1;           \
	done
